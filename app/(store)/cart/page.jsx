	...
	return (
		<div className="sm:p-6 md:p-10">
			<div className="container grid w-full max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
				...
				<section className="md:col-span-2 rounded-2xl bg-white p-4 sm:p-6 shadow-xl ring-1 ring-gray-100">
					<div className="mb-4 sm:mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
						...
						<div className="flex flex-wrap items-center gap-2 sm:gap-3">
							...
							<Link
								href="/"
								className="flex items-center rounded-xl border border-gray-200 px-3 py-2 sm:px-4 sm:py-2 text-xs sm:text-sm font-semibold text-gray-700 transition hover:bg-[#b2c3e9] active:scale-[.99]"
							>
								...
								return (
									...
									>
										...
										<div className="col-span-3 flex items-center gap-3 sm:gap-4">
											<div className="relative h-24 w-24 overflow-hidden rounded-lg ring-1 ring-gray-200 bg-[#e5e7eb] shrink-0">
												<Image
													src={item.image}
													alt={item.title}
													fill
											...
											<div className="min-w-0">
												...
												{item.category && (
													<p className="mt-0.5 text-xs sm:text-sm capitalize text-[#8C9EC5]">
														{item.category}
													</p>
												)}
				...
				{/* Summary / Checkout */}
				<aside className="md:sticky md:top-20 h-fit rounded-lg bg-white p-4 sm:p-6 shadow-xl ring-1 ring-gray-100 self-start">
					...
					<div className="mt-4 sm:mt-6 space-y-2 text-sm sm:text-base">
						<div className="flex items-center justify-between text-[#8C9EC5]">
							<span>Subtotal</span>
						...
						<div className="flex items-center justify-between border-t border-gray-200 color-primary pt-3 text-base sm:text-lg font-bold">
							<span>Total</span>
							<span>{cashFormat(total)}</span>
						</div>
						<button
