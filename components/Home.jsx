      ...
      <aside
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <ul
            ...
            className="divide-y divide-gray-100 rounded-lg border border-gray-100 bg-gray-50"
          >
            {categoryList.map((c) => {
              ...
              return (
                <li key={c.name}>
                  ...
                  >
                    ...
                    <span
                      className={`text-xs ${
                        selected ? 'text-[#8C9EC5]' : 'text-gray-400'
                      }`}
                    >
                      ({c.count})
                    </span>
        ...
        <div className="mt-3 flex items-center justify-between text-xs text-gray-500">
          <span>
            Showing <b className="text-gray-700">{filteredProducts.length}</b> of{' '}
            <b className="text-gray-700">{totalCount}</b>
          </span>
          {category !== 'all' && (
            <button
